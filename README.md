...
A minimal, fast personal blog built with Jekyll and the no-style-please theme.

## Features

- ✅ Dark mode by default
- ✅ System default fonts for fast loading
...
1. Create a new repository named `dearcloud09.github.io` on GitHub
...
git branch -M main
git remote add origin https://github.com/dearcloud09/dearcloud09.github.io.git
...
4. Your blog will be available at https://dearcloud09.github.io
...
- Edit `_data/menu.yml` for navigation menu
- Edit `_sass/no-style-please.scss` for styling
- Edit `_sass/syntax-highlighting.scss` for code theme
